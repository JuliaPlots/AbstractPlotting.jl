...
f = Figure()
stem(f[1, 1], xs, sin, stemcolor = :red, color = :orange,
    markersize = 15, strokecolor = :red, strokewidth = 3)
stem(f[1, 2], xs, sin.(xs), offset = 0.5, trunkcolor = :blue, marker = :rect)
stem(f[2, 1], xs, sin.(xs), offset = LinRange(-0.5, 0.5, 30),
