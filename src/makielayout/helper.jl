...
function axislines!(scene, rect, spinewidth, topspinevisible, rightspinevisible,
    ...
    (linesegments!(scene, bottomline, linewidth = spinewidth, show_axis = false,
        visible = bottomspinevisible, color = bottomspinecolor)[end],
    linesegments!(scene, leftline, linewidth = spinewidth, show_axis = false,
        visible = leftspinevisible, color = leftspinecolor)[end],
    linesegments!(scene, rightline, linewidth = spinewidth, show_axis = false,
        visible = rightspinevisible, color = rightspinecolor)[end],
    linesegments!(scene, topline, linewidth = spinewidth, show_axis = false,
